...
function listCards(leagues, colsCards) {
  leagues.forEach(item => {
    ...
    if (item.live_standings == true) {
      ...
      colAuto.appendChild(cardLeague);
      colsCards.appendChild(colAuto);
    }
  });
}
